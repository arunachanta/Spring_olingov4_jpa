...
import com.walmart.rebates.core.foundation.GenericEdmProvider;
 ...
 * e.g. http://localhost:8080/odata/$metadata
 */
@Component
public class ProductEdmProvider extends GenericEdmProvider {
    ...
    public ProductEdmProvider() {
		super.setObjectFQDN(ET_PRODUCT_FQN,ES_PRODUCTS_NAME,ET_PRODUCT_NAME);
